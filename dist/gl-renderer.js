...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "774faefa87105da4924b";
...
var _samplerMap = Symbol('samplerMap');
...
function _fetchShader() {
  ...
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee4(url) {
    var res, content;
...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(Renderer, [{
    ...
    value: function setProgram(fragmentShader, vertexShader) {
      ...
      if (matched) {
        matched.forEach(function (m) {
          ...
          _this.declareUniform(name, type);
        });
      }
    ...
    key: "bindTexture",
    value: function bindTexture(source, i) {
      var gl = this.gl;
    ...
    value: function declareUniform(name) {
      ...
      if (type === 'sampler2D') {
        var samplerID = this[_samplerMap][name];
        ...
        Object.defineProperty(this.uniforms, name, {
          ...
          set: function set(v) {
            value = v;
            var idx = samplerID || textures.length;
            textures[idx] = v;
    ...
    value: function update() {
      ...
      if (this[_renderFrameID] == null) {
        this[_renderFrameID] = requestAnimationFrame(function () {
          _this2[_renderFrameID] = null;
